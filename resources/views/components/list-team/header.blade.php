...
<div class="header">
    ...
    <div class="header_center">
        ...
        <div class="header_center__search">
            <form action="{{route('search.team')}}" class="search search-pc" id="submitSearch" onsubmit="return validateMyForm()">
                <div class="form__group">
                    <button style="padding: 0; border:none" id="btn__submit" >
                        <i id="find" class='bx bx-search' onclick="handleSubmit()"></i>
                    </button>
                    <input type="text" name="key" class="inp" placeholder="Tìm đội" id="filter_search" autocomplete="off" value="{{request()->get('key')}}">
                </div>
