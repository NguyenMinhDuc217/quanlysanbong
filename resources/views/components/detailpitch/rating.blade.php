...
<div class="detail">
    <div class="detail_desc">
        <div class="detail_rating">
            <span class="detail_rating__title">Đánh giá Sân bóng CLB Bóng Đá Quang Tuyến</span>
            <span class="detail_rating_title_desc">Có 0 đánh giá về Sân bóng CLB Bóng Đá Quang Tuyến</span>
            <div style="min-height: 100%; border:0.2px solid #ffffff;"></div>

            <div class="detail__rating__right">
                <p class="title">Over view: 3&nbsp;<i class='bx bxs-star'></i></p>
                ...
                <div class="histo" id="histo">
                    <div class="five histo-rate">
                        ...
                        <span class="bar-block">
                            <span id="bar-five" class="bar" count="">
                                &nbsp;
                            </span>
                        </span>
                    </div>
                    ...
                    <div class="four histo-rate">
                        ...
                        <span class="bar-block">
                            <span id="bar-four" class="bar" count="">
                                &nbsp;
                            </span>
                        </span>
                    </div>
                    ...
                    <div class="three histo-rate">
                        <span class="histo-star">
                            3 sao</span>
                        <span class="bar-block">
                            <span id="bar-three" class="bar" count="">
                                &nbsp;
                            </span>
                        </span>
                    </div>
                    ...
                    <div class="two histo-rate">
                        <span class="histo-star">
                            2 sao</span>
                        <span class="bar-block">
                            <span id="bar-two" class="bar" count="">
                                &nbsp;
                            </span>
                        </span>
                    </div>
                    ...
                    <div class="one histo-rate">
                        <span class="histo-star">
                            1 sao</span>
                        <span class="bar-block">
                            <span id="bar-one" class="bar" count="">
                                &nbsp;
                            </span>
                        </span>
                    </div>
