...
@section('content_header', 'Số lượt đặt sân')
...
<form style="margin: 10px;" method="GET" action="{{route('show.chart.set.pitch',)}}">
...
$(function() {
  ...
  function requestData(days, chart){
       ...
       console.log(start,end,fillter);
    $.ajax({
      type: "GET",
      dataType: 'json',
      url: "./chart/set-pitch?timeStart="+start+"&timeEnd="+end+"&fillter="+fillter, // This is the URL to the API
      data: { days: days }
    })
    .done(function( data ) {
      chart.setData(data);
  ...
  var chart = Morris.Bar({
    ...
    labels: ['Số lần đặt sân '],// Set the label when bar is rolled over
    barColors: ["#1AB244"],
  });
