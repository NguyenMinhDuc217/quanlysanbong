    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="col-md-12">
              ...
              <form method="POST" action="{{route('discount.pitch')}}" enctype="multipart/form-data">
             @csrf
                ...
                <div class="card-body">
                    <div class="multiselect">
                        ...
                        <div id="checkboxes">
                             ...
                             <label for="{{$pitch->id}}">
                            <input type="checkbox" id="{{$pitch->id}}" name="namepitch[{{$pitch->id}}]" value="{{$pitch->id}}" />{{$pitch->name}}</label>
                             @endforeach
                        </div>
                        </div>
